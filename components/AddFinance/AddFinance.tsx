             ...
             active:scale-95"
						...
						{category?.id === c?.id && (
							<>
								...
								<div
									className={"relative flex gap-2 items-center mt-2 h-[30px]"}
								>
									<label className={"flex flex-col text-sm w-full"}>
										<input
											onChange={onHandleChangeDescrip}
											value={description}
											className={"border-2"}
										/>
									</label>
									...
									{amount && (
										<div
											className={
												"bg-white absolute top-[35px] left-0 w-full flex gap-2"
											}
										>
											<button
												onClick={() => onHandleSubmit("cash")}
												className={
													"font-bold border-2 border-amber-700 text-black z-50 flex gap-2 justify-center items-center  top-[35px] left-0 h-[64px]  w-1/2 bg-gray-White_dark rounded-3xl"
												}
											>
												<IconCash />
												CASH
											...
											<button
												onClick={() => onHandleSubmit("card")}
												className={
													"font-bold border-2 border-amber-700 text-black z-50 flex gap-2 justify-center items-center  top-[35px] left-[50%] h-[64px] w-1/2 bg-gray-White_dark rounded-3xl"
												}
											>
												<IconCARD />
												CARD
